...
% Simulation Settings
takeOffDuration = 0; % 1-Permite que o quadricóptero de comporte diferente durante o levanto de voo. 0-Desliga essa capacidade
enableLanding = false; %True - Pousa quando o quadricopero atinge alguma condição pre estabelecida; False-Desli9ga essa capacidade
landingAltitude = -0.6;
